...
public record UsosThesis(String id, UsosThesisType type, String title, UsosLocalizedString titles,
                         UsosThesisDataLanguage language,
                         List<UsosUser> authors, List<UsosUser> supervisors,
                         UsosFaculty faculty) implements UsosCommonObject {
