...
public record UsosFaculty(String id, UsosLocalizedString name, String profileUrl, String homepageUrl,
                          ...
                          List<UsosFacultyShort> path, UsosFacultiesStaticMaps staticMapUrls,
                          UsosFacultiesLogos logoUrls,
                          UsosFacultiesCovers coverUrls, String pdfFactsheetUrl) implements UsosCommonObject {}